...
notebook_files = ["julia-intro-slides.jl", "predator-prey-slides.jl", "julia-basics.jl", "julia-packages.jl", "plotting-with-makie.jl"]
script_files = ["julia-basics.jl", "julia-packages.jl", "plotting-with-makie.jl"]
