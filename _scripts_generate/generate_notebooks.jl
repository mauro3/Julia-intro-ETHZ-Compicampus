...
notebook_files = ["julia-intro-slides.jl", "julia-basics.jl", "julia-packages.jl", "plotting-with-makie.jl", "predator-prey.jl"]
script_files = ["julia-basics.jl", "julia-packages.jl", "plotting-with-makie.jl", "predator-prey.jl"]
